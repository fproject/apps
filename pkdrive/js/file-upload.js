		...
		if ( $('#file_upload_start').exists() ) {
			var file_upload_param = {
				...
				start: function(e) {
					...
					console.log('start console', e, null);
					$('#upload').tipsy('hide');
				},
				submit: function(e, data) {
					OC.Upload.rememberUpload(data);
					console.log('submit console', e, null);
					if (!data.formData) {
						data.formData = {};
					}
				...
				fail: function(e, data) {
					...
					console.log('fail console', e, null);
				 ...
				 */
					...
					console.log('done console', e, null);
				...
				stop: function(e, data) {
					...
					console.log('stop console', e, null);
				}
			};
