...
(function() {
	...
	FileList.prototype = {
		...
		linkTo: function(dir) {
			return OC.linkTo('pkdrive', 'index.php')+"?dir="+ encodeURIComponent(dir).replace(/%2F/g, '/');
		},
		...
		setupUploadEvents: function() {
			...
			fileUploadStart.on('fileuploaddrop', function(e, data) {
				...
				console.log('filelist handle fileuploaddrop at console');
			...
			fileUploadStart.on('fileuploadadd', function(e, data) {
				...
				console.log('filelist handle fileuploadadd at console');
			...
			fileUploadStart.on('fileuploaddone', function(e, data) {
				...
				console.log('filelist handle fileuploaddone at console');
				var response;
			...
			fileUploadStart.on('fileuploadstop', function(e, data) {
				...
				console.log('filelist handle fileuploadstop at console');
			...
			fileUploadStart.on('fileuploadfail', function(e, data) {
				...
				console.log('filelist handle fileuploadfail at console');
				//if user pressed cancel hide upload chrome
				if (data.errorThrown === 'abort') {
					//cleanup uploading to a dir
					var uploadText = $('tr .uploadtext');
